...
namespace Bustrap
{
    internal class Installer
    {
        ...
        public bool BustrapRPCReal = true;
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Bustrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "1.0.3.6") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Bustrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Bustrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Bustrap-v{currentVer}");

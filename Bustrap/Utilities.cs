    ...
    static class Utilities
    {
        ...
        public static VersionComparison CompareVersions(string versionStr1, string versionStr2)
        {
            ...
            catch (Exception)
            {
                ...
                // https://github.com/BloxstrapLabs/Bustrap/issues/3193
        ...
        {
            using EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "Bustrap-BackgroundUpdaterKillEvent");
            handle.Set();
        }

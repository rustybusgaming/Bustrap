    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconBustrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconBustrap => Properties.Resources.IconBustrap,
                ...
                _ => Properties.Resources.IconBustrap
            };
        }
    }
}

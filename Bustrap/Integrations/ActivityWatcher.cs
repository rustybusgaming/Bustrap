...
using static Bustrap.Models.Persistable.AppSettings;

namespace Bustrap.Integrations
{
    public class ActivityWatcher : IDisposable
    {
        private const string GameMessageEntry = "[FLog::Output] [BustrapRPC]";
        ...
        private const string GameMessageEntryPattern = @"\[BustrapRPC\] (.*)";

...
namespace Bustrap.RobloxInterfaces
{
    public static class Deployment
    {
        ...
        static Deployment()
        {
            SharedHttp.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "BustrapUpdater/2.0");
            ...
            DownloadForModGenerator(bool overwrite = false)
        {
            ...
            string tmp = Path.Combine(Path.GetTempPath(), "Bustrap");

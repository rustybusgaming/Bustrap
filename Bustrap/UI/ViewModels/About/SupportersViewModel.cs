...
namespace Bustrap.UI.ViewModels.About
{
    public class SupportersViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async void LoadSupporterData()
        {
            ...
            try
            {
                SupporterData = await Http.GetJson<SupporterData>("https://raw.githubusercontent.com/rustybusgaming/Bustrap/main/supportersdata7.json");
            }
            catch (Exception ex)
            {

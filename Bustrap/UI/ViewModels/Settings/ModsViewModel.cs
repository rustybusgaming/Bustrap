...
using static Bustrap.UI.Elements.Settings.Pages.ModsPage;
...
namespace Bustrap.UI.ViewModels.Settings
{
    public class ModsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async Task LoadModsAsync() // was working on this but idk fuc
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("BustrapApp");
        ...
        {
            _http.DefaultRequestHeaders.UserAgent.ParseAdd("BustrapSkyboxClient");
    ...
    GetVisibility(Path.Combine(Paths.Mods, "Content", "textures", "Cursors", "KeyboardMouse"),
        ...
        private readonly string _dir =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Bustrap");

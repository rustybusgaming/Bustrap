...
using Bustrap.UI.ViewModels.Bootstrapper;
...
namespace Bustrap.UI.Elements.Bootstrapper
{
    ...
    public partial class CustomDialog : IBootstrapperDialog
    {
        ...
        public Bustrap.Bootstrapper? Bootstrapper { get; set; }
        ...
        public CustomDialog()
        {
            ...
            .OfType<Bustrap.UI.Elements.Settings.MainWindow>()
            .FirstOrDefault();
            if (App.Settings.Prop.BackgroundWindow)
            {
                _mainWindow?.Hide();
            }
            Bustrap.UI.Elements.Bootstrapper.AudioPlayerHelper.PlayStartupAudio();
            this.Closed += (s, e) =>
            {
                _mainWindow = System.Windows.Application.Current.Windows
                .OfType<Bustrap.UI.Elements.Settings.MainWindow>()
                ...
                Bustrap.UI.Elements.Bootstrapper.AudioPlayerHelper.StopAudio();
            };

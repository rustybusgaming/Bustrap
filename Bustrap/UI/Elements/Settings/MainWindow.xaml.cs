...
namespace Bustrap.UI.Elements.Settings
{
    public partial class MainWindow : INavigationWindow
    {
        ...
        private void UpdateDiscordPresence()
        {
            ...
            {
                Details = $"Viewing {pageName}", // the fuck was there state I just relized that it already displays fucking Bustrap THE FUCK
            ...
            new DiscordRPC.Button
            {
                ...
                Url = "https://github.com/rustybusgaming/Bustrap"
            }
        }
            });
        }

    ...
    public partial class ChannelPage
    {
        ...
        private void ApplyNow_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Frontend.ShowMessageBox("Bustrap Settings/Mods Synced"); // diddy is synced :)))))))))) eheh not funny ik.. sorry
            }
            catch (Exception ex)
            {
        ...
        private async void Check_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (IsNewerVersion(latestVersion, currentVersion))
                {
                    ...
                    string exeUrl = "https://github.com/rustybusgaming/Bustrap/releases/latest/download/Bustrap.exe";
                    string tempPath = Path.Combine(Path.GetTempPath(), "Bustrap_update.exe");

                    using (var client = new HttpClient())
                    {
                        client.DefaultRequestHeaders.Add("User-Agent", "Bustrap-Updater");
                ...
                {
                    Frontend.ShowMessageBox(
                        "You are already running the latest version of Bustrap."
                    );
                }
            }
            catch (Exception ex)
        ...
        private async Task<string> GetLatestGitHubVersion()
        {
            ...
            string apiUrl = "https://api.github.com/repos/rustybusgaming/Bustrap/releases/latest";
        ...
        {
            string url = "https://Bustrapp.netlify.app/donate/donate";
            try
            {

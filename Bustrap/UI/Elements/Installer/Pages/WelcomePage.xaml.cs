...
using Bustrap.UI.ViewModels.Installer;

namespace Bustrap.UI.Elements.Installer.Pages
{
    /// <summary>
    ...
    public partial class WelcomePage
    {
        ...
        {
            Process.Start(new ProcessStartInfo("https://Bustrapp.netlify.app/donate/donate") { UseShellExecute = true });
        }
        private void ContributorsButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            Process.Start(new ProcessStartInfo("https://Bustrapp.netlify.app/contributors/contributors") { UseShellExecute = true });
        }
    }
}

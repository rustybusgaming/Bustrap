...
using Bustrap.UI.Chat;
using Bustrap.UI.Elements.Crosshair;
using Bustrap.UI.Elements.FPS;
using Bustrap.UI.Elements.Overlay;
using Bustrap.UI.Elements.Settings.Pages;
    ...
    public partial class MenuContainer
    {
        ...
        public void ActivityWatcher_OnGameJoin(object? sender, EventArgs e)
        {
            ...
            if (App.Settings.Prop.IngameChatDiscord)
            {
                Application.Current.Dispatcher.Invoke(() =>
                {
                    if (App.Current.Resources["DiscordChatOverlayWindow"]
                        is Bustrap.UI.Elements.Overlay.DiscordChatOverlayWindow existing)
                    {
                    ...
                    var discordOverlay = new Bustrap.UI.Elements.Overlay.DiscordChatOverlayWindow();
                    discordOverlay.Show();
            ...
            if (App.Settings.Prop.OverlaysEnabled)
            {
                Application.Current.Dispatcher.Invoke(() =>
                {
                    if (App.Current.Resources["OverlayWindow"] is Bustrap.UI.Elements.Overlay.OverlayWindow existing)
                    {
                        if (existing.IsLoaded)
                        {
                            return;
                    ...
                    var overlay = new Bustrap.UI.Elements.Overlay.OverlayWindow();
                    overlay.Show();
        ...
        public void ActivityWatcher_OnGameLeave(object? sender, EventArgs e)
        {
            Application.Current.Dispatcher.Invoke(() =>
            {
                ...
                if (App.Current.Resources["OverlayWindow"] is Bustrap.UI.Elements.Overlay.OverlayWindow overlay)
                {
                    overlay.Close();
                    App.Current.Resources.Remove("OverlayWindow");
                }

                if (App.Current.Resources["DiscordChatOverlayWindow"] is Bustrap.UI.Elements.Overlay.DiscordChatOverlayWindow discordOverlay)
                {
